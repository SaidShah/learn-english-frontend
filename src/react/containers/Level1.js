  ...
  <>
      ...
      <div className="text-align-center">
        <h1 className="special-blue-text">Practice Vocabulary</h1>
          ...
          <div className="flex-container">
            ...
            <div>
            <Link to="/level1/vegetable"><VocabularyCard type={"Vegetables"} image={vegetables}/></Link>
            </div>
            <div >
            <Link to="/level1/clothes"><VocabularyCard type={"Clothes"}  image={clothes}/></Link>
            </div>
            <div>
            <Link to="/level1/animal"><VocabularyCard type={"Animals"} image={animals}/></Link>
            </div>
          </div>
          <div className="text-align-center">
            ...
            <div className="flex-container">
              <div>
              <Link to="/level1/body"><VocabularyCard type={"Body Parts"} image={body}/></Link>
              </div>
              <div>
              <Link to="/level1/number"><VocabularyCard type={"Numbers"} image={numbers}/></Link>
              </div>
              <div >
              <Link to="/level1/random"><VocabularyCard type={"Random Words"} image={random} /></Link>
              </div>
            </div>
      </div>
  </>
    ...
    return (
      ...
      {localStorage.token ?
        <>
      <Switch>
        <Route exact path="/level1/:category" render={props => <Level1Category type={props.match.params.category}/>}/>
