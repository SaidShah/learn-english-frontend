      ...
      <>
        <div>
          ...
          <div className="flex-container">
            <div>
              <Link to="/level2/pronoun">
                <Sentence
                  kind="pronoun"
                  definition={this.pronounDefinition()}
                  image_url={pronounImage}
                />
              </Link>
            </div>
            <div>
              <Link to="/level2/noun">
                <Sentence
                  kind="noun"
                  definition={this.nounDefinition()}
                  image_url={nounImage}
                />
              </Link>
            </div>
            <div>
              <Link to="/level2/adjectives">
                <Sentence
                  kind="adjectives"
                  definition={this.adjectiveDefinition()}
                  image_url={adjectiveImage}
                />
              </Link>
            </div>
            <div>
              <Link to="/level2/verb">
                <Sentence
                  kind="verb"
                  definition={this.verbDefinition()}
                  image_url={verbImage}
                />
              </Link>
            </div>
          ...
          <div className="flex-container">
            <div>
              <Link to="/level2/adverb">
                <Sentence
                  kind="adverb"
                  definition={this.adverbDefinition()}
                  image_url={adverbImage}
                />
              </Link>
            </div>
            <div>
              <Link to="/level2/preposition">
                <Sentence
                  kind="prepositions"
                  definition={this.prepositionDefinition()}
                  image_url={prepositionImage}
                />
              </Link>
            </div>
            <div>
              <Link to="/level2/conjunction">
                <Sentence
                  kind="conjunction"
                  definition={this.conjunctionDefinition()}
                  image_url={conjunctionImage}
                />
              </Link>
            </div>
            <div>
              <Link to="/level2/interjection">
                <Sentence
                  kind="interjection"
                  definition={this.interjectionDefinition()}
                  image_url={interjectionImage}
                />
              </Link>
            </div>
          </div>
        ...
        {localStorage.token ? (
          <>
            <Switch>
              <Route
                exact
                path="/level2/:category"
                render={props => (
                  <Level2Category type={props.match.params.category} />
                )}
              />
