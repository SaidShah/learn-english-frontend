      ...
      <>
        <div>
          ...
          <div className="flex-container">
            ...
            <div>
              <Link to="/level3/mediumWord">
                <Unscramble
                  image_url={mediumWords}
                  type={"mediumWord"}
                  title={"medium Words"}
                />
              </Link>
          ...
          <>
            <Switch>
              <Route
                ...
                path="/level3/:type"
                render={props => (
                  <Level3Category type={props.match.params.type} />
                )}
              />
